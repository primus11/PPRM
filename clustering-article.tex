...
to test k-means, GMM and DBSCAN. We used our own implementation of ECMC and a \textit{R} library
...
not linearly seperable either. Presented on figure \ref{dataset3}.
...
DBSCAN was slightly worse than others. The reason is that DBSCAN is detecting noise as well.
...
This dataset is actually the most difficult one in our comparison. k-means, ECMC and GMM
...
DBSCAN and spectral clustering had no problem as we can see in table \ref{halfmoonsresults}. However, because of
