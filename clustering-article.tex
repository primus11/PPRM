...
\begin{itemize}
    ...
    are connected.
    \item $k$-nearest neighbor graph: Each example is connected with its nearest $k$ examples.
    \item Fully connected graph: Simply connecting all examples with each other.
\end{itemize}
