...
that differ significantly in their notion of what constitutes a cluster of how to find them.
...
used k-means, through more advanced Expectation Maximization and density-based algorithms as well
as some newer developments such as spectral clustering and information theoretic clustering.
...
ECM (Evolving Clustering Method) is a dynamic clustering method mostly used as a fast \textit{one-pass} online algorithm. % with fast \textit{one-pass} method.
