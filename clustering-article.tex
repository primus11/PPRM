...
We also experimentaly compare these algorithms.
...
For each algorithm comparison on three different datasets was done. The first dataset, shown in picture \ref{dataset1},
