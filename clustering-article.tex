...
ECM (Evolving Clustering Method) is a dynamic clustering method mostly used for on-line system with fast "one-pass" algorithm.
Its extension ECMc (Evolving Clustering Method with Constrained minimization) is used for off-line where constrained optimization
